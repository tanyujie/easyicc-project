...
public class MiniHtmlController extends IdentityRepository{
	@Autowired
	private MiniHtmlService service;
	...
	@ResponseBody
	public RestResult add(MiniHtml bean) {
	...
	@ResponseBody
	public RestResult update(MiniHtml bean) {
