...
ID	NUMBER	10	0	0	-1					0	0	0			
COMPANY_ID	NUMBER	10	0	0	0	公司id				0	0	0			
CMD	VARCHAR2	100	0	-1	0	结构体				0	0	0	CHAR		
CONFIG	VARCHAR2	3000	0	-1	0	结构体				0	0	0	BYTE		
TPL	VARCHAR2	3000	0	-1	0	结构体				0	0	0	BYTE		
PARAM_TYPE	VARCHAR2	50	0	-1	0	参数类型				0	0	0	BYTE		
STATUS	NUMBER	10	0	-1	0	状态0：关闭,1：启用				0	0	0			
INTERFACE_URL	VARCHAR2	255	0	-1	0	接口地址				0	0	0	BYTE		
COMPANY_NAME	VARCHAR2	100	0	-1	0	公司name				0	0	0	BYTE		
BODY_TYPE	VARCHAR2	50	0	-1	0	body数据类型				0	0	0	BYTE		
IS_DATA_SIGN	VARCHAR2	10	0	-1	0	是否数据签名: 1:是，0：否				0	0	0	BYTE		
SIGN_ALGORITHM	VARCHAR2	50	0	-1	0	签名算法				0	0	0	BYTE		
SIGN_BODY	VARCHAR2	500	0	-1	0	签名结构体				0	0	0	BYTE		
CONTAIN_TYPE	VARCHAR2	500	0	-1	0	包含类型				0	0	0	BYTE		
CONTAIN_RULE	VARCHAR2	1000	0	-1	0	包含规则				0	0	0	BYTE		
THIRD_PLATFORM	VARCHAR2	500	0	-1	0	第三方平台				0	0	0	BYTE		
