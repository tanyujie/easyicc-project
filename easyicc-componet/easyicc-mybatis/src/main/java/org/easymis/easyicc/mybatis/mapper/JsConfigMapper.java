...
public interface JsConfigMapper {
	...
	public List<JsConfig> getList(HashMap<String, Object> params);
	...
	public void save(JsConfig bean);
	...
	public void update(JsConfig bean);
	...
	public JsConfig findById(String config_id);
