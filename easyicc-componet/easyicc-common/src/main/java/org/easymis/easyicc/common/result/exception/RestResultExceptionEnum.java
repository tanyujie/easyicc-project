...
public enum RestResultExceptionEnum implements ResultEnum {
	...
	USER_FIRST_LOGIN_CHANGE_PASSWORD(1000009, "您好，首次登陆请修改密码"),
	USER_FIRST_LOGIN_CHANGE_PASSWORD_EXPIRE(1000010, "设置密码已过期"),
	USER_FIRST_LOGIN_CHANGE_PASSWORD_ILLEGAL(1000011, "密码非法法修改"),
	FILE_MAX_UPLOAD_MAX_EXCEED_ERROR(1000012, "文件大小超过100M限制"),

	USER_PASSWORD_RULE(1000013, "密码长度为6到20位，必须包含数字、小写字母、大写字母"),
	USER_PASSWORD_NOT_EQUQAL(1000014, "密码和确认密码不一致"),
	USER_PASSWORD_OLD_ERROR(1000015, "原密码错误"),

	ALIYUN_SMS_ERROR(1000015, "短信发送失败"),
	ELASTIC_SEARCH_MAXRECORD(1000016, "超出ElasticSearch最大记录限制"),
	;
	...
	private RestResultExceptionEnum(Integer code, String msg) {
		this.code = code;
		this.msg = msg;
	}
